...
export default function Layout() {
  ...
  const { authUser, userRole } = useAppContext();
  ...
  return (
    <div
      className={`relative z-0 flex min-h-[100dvh] min-h-screen w-full max-w-full flex-col overflow-x-hidden text-neutral-950 selection:bg-[#DFFF00]/50 selection:text-black ${cp.bgPage}`}
    >
